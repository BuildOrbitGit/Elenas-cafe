  ...
  return (
    <main className="min-h-screen overflow-hidden bg-cream text-stone-800">
      ...
      <section id="home" className="relative flex min-h-screen items-center overflow-hidden px-5 pt-28 text-white lg:px-8">
        <video
          className="absolute inset-0 h-full w-full object-cover saturate-[1.12] contrast-[1.06] brightness-[1.04]"
          src="/elena/video/hero-cafe-enhanced.mp4"
          autoPlay
          muted
          loop
          playsInline
          preload="auto"
          poster="/elena/video/hero-cafe-poster.jpg"
          aria-label="Warm cafe video background"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-950/50 via-emerald-950/18 to-emerald-950/0" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_36%,rgba(255,247,231,0.06),transparent_26rem),linear-gradient(180deg,rgba(21,51,34,0.02),rgba(21,51,34,0.28))]" />
